ONLYONET.Resources = {
    ...
    "box-database-info-description-line2": "UNIVAULTOFFICE uses AES-256 to encrypt your files, and asymmetric encryption algorithm to securely store the encryption data in the private database on your portal.",
    "box-database-connect-description-line1": "Before you start:",
    "box-database-connect-description-line2": "Log in to your UNIVAULTOFFICE portal via  <strong>Connect to cloud</strong> section",
    "box-database-connect-description-line3": "Obtain your personal encryption data using the button below.",
    "box-database-connect-description-line4": "UNIVAULTOFFICE will generate your individual pair of the encryption keys: public and private. Your private key (used for decrypting the documents) will be stored on this machine. For the correct work of the application, do not remove this file. You may keep a copy in some other location as a backup.",

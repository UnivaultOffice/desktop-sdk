...
URL: http://univaultoffice.github.io/
Vendor: UNIVAULTOFFICE (Online documents editor)
Packager: UNIVAULTOFFICE (Online documents editor) <support@univaultoffice.github.io>
...
%changelog
* Tue Feb 02 2016 UNIVAULTOFFICE (Desktop editor) <support@univaultoffice.github.io>
- Initial release.
